...
class sspmod_ingameauth_Auth_Source_External extends SimpleSAML_Auth_Source {
	...
	private function getUser() {
		...
		if(!sspmod_ingameauth_Auth_Source_External::hash_compare($computed_signature,$signature_hex)) {
			
			throw new SimpleSAML_Error_BadRequest("Invalid sig: len=".strlen($signature_hex));
			return NULL;
		}
